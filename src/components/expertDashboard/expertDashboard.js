...
const ExpertDashboard = () => {
    ...
    useEffect(() => {
        const fetchExpertDetails = async () => {
            try {
                const response = await axios.get('http://localhost:3001/expert-details', { withCredentials: true });
    ...
    const handleLogout = async () => {
        try {
            await axios.post('http://localhost:3001/expert-logout', {}, { withCredentials: true });
