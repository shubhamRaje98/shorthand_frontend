...
const ExpertDashboard = () => {
    ...
    useEffect(() => {
        const fetchExpertDetails = async () => {
            try {
                const response = await axios.get('http://43.205.192.129:3000/expert-details', { withCredentials: true });
    ...
    const handleLogout = async () => {
        try {
            await axios.post('http://43.205.192.129:3000/expert-logout', {}, { withCredentials: true });
