...
const ExpertDashboard = () => {
    ...
    useEffect(() => {
        const fetchExpertDetails = async () => {
            try {
                const response = await axios.get('http://3.111.171.201:3000/expert-details', { withCredentials: true });
    ...
    const handleLogout = async () => {
        try {
            await axios.post('http://3.111.171.201:3000/expert-logout', {}, { withCredentials: true });
