...
const ExpertDashboard = () => {
    ...
    useEffect(() => {
        const fetchExpertDetails = async () => {
            try {
                const response = await axios.get('http://45.119.47.81:3000/expert-details', { withCredentials: true });
    ...
    const handleLogout = async () => {
        try {
            await axios.post('http://45.119.47.81:3000/expert-logout', {}, { withCredentials: true });
