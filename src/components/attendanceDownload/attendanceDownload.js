...
const AttendanceDownload = () => {
    ...
    const fetchDepartments = async () => {
        ...
        try {
            console.log('Making request to:', 'http://localhost:3001/get-active-departments');
            const response = await axios.get('http://localhost:3001/get-active-departments');
    ...
    const fetchController = async () => {
        try {
            const response = await axios.post('http://localhost:3001/get-batch-controller-password', {
                batchNo,
                departmentId
            });
    ...
    const fetchBatches = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:3001/track-students-on-exam-center-code', {
                departmentId
            });
    ...
    const handleDownload = async (reportType) => {
        ...
        try {
            const response = await axios({
                url: `http://localhost:3001/center/${reportType}-pdf-download`,
                method: 'POST',
    ...
    const handleExcelDownload = async () => {
        ...
        try {
            const response = await axios({
                url: 'http://localhost:3001/center/studentId-password',
                method: 'POST',
                data: { batchNo, departmentId },
                responseType: 'blob',
                headers: {
