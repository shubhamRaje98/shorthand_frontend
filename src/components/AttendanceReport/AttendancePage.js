...
const AttendancePage = () => {
    ...
    const fetchBatches = async () => {
        try {
            const response = await axios.post('http://localhost:3004/track-students-on-exam-center-code');
    ...
    const fetchDepartments = async () => {
        try {
            const response = await axios.get('http://localhost:3004/get-active-departments');
    ...
    const fetchReports = async () => {
        try {
            const response = await axios.get('http://localhost:3004/get-attendance-report');
    ...
    const handleDeleteReport = async (batchNo, departmentId) => {
        try {
            const response = await axios.post('http://localhost:3004/delete-atttendance', { 
                batchNo, 
                departmentId 
            });
...
const AttendanceUploadForm = ({ batches, departments, onUploadSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:3004/upload-attendance', data, {
