...
const AttendancePage = () => {
    ...
    const fetchAllBatches = async () => {
        try {
            ...
            const response = await axios.post(
                'http://checking.shorthandonlineexam.in/track-students-on-exam-center-code/all',
                {},
    ...
    const fetchReports = async () => {
        try {
            const response = await axios.get('http://checking.shorthandonlineexam.in/get-attendance-report');
    ...
    const handleDeleteReport = async (batchNo, departmentId) => {
        ...
        try {
            ...
            const response = await axios.post('http://checking.shorthandonlineexam.in/delete-atttendance', {
                batchNo,
                departmentId
            }, { withCredentials: true });
...
const AttendanceUploadForm = ({ batches, departments, onUploadSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://checking.shorthandonlineexam.in/upload-attendance', data, {
