...
const AttendancePage = () => {
    ...
    const fetchAllBatches = async () => {
        try {
            ...
            const response = await axios.post(
                'http://localhost:3001/track-students-on-exam-center-code/all',
                {},
    ...
    const fetchReports = async () => {
        try {
            const response = await axios.get('http://localhost:3001/get-attendance-report');
    ...
    const handleDeleteReport = async (batchNo, departmentId) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:3001/delete-atttendance', { 
                batchNo, 
                departmentId 
            }, { withCredentials: true });
...
const AttendanceUploadForm = ({ batches, departments, onUploadSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:3001/upload-attendance', data, {
