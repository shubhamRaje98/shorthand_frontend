...
const PCRegistration = () => {
    ...
    const fetchData = async () => {
        ...
        setError('');
        try {
            const response = await axios.get(`http://43.205.192.129:3000/get-pcregistration`);
    ...
    const handleDelete = async (item) => {
        ...
        try {
            const response = await axios.post('http://43.205.192.129:3000/delete-pcregistration', {
