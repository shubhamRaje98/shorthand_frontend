...
const PCRegistration = () => {
  ...
  const fetchData = async () => {
    ...
    setError('');
    try {
      const response = await axios.get(`https://checking.shorthandonlineexam.in/get-pcregistration`);
  ...
  const handleDelete = async (item) => {
    ...
    try {
      const response = await axios.post('https://checking.shorthandonlineexam.in/delete-pcregistration', {
        id: item.id
      });
