...
const PCRegistration = () => {
    ...
    const fetchData = async () => {
        ...
        setError('');
        try {
            const response = await axios.get(`http://3.111.171.201:3000/get-pcregistration`);
    ...
    const handleDelete = async (item) => {
        ...
        try {
            const response = await axios.post('http://3.111.171.201:3000/delete-pcregistration', {
