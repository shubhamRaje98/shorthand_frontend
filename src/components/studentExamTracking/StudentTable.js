...
//   const [currentPage, setCurrentPage] = useState(1);
//   const [rowsPerPage, setRowsPerPage] = useState(10);
//   const [totalPages, setTotalPages] = useState(0); // This was missing!
...
//     const inProgressExams = data.filter(item => 
//       isValidData(item.loginTime) && !isValidData(item.feedback_time)
//     ).length;
...
//                     Real-time monitoring of shorthand examination progress
//                   </Typography>
//                 </Box>
//               </Box>
//               <Box display="flex" alignItems="center">
...
//                   label={`Logged In: ${total_login_count}`}
//                   style={{ 
...
//         {/* Error State */}
//         {error && !loading && (
//           <Paper style={{ padding: 16, marginBottom: 24, backgroundColor: "#fff3cd", border: "1px solid #ffeaa7" }}>
...
//                       <TableCell className={getCellClass(item, "loginTime", exam_type, classes)}>
//                         {formatDate(item.loginTime)}
//                       </TableCell>
//                       {exam_type !== "typewriting" && (
//                         <TableCell className={getCellClass(item, "trial_time", exam_type, classes)}>
//                           {formatDate(item.trial_time)}
//                         </TableCell>
//                       )}
//                       {exam_type !== "typewriting" && (
//                         <>
//                           <TableCell className={getCellClass(item, "audio1_time", exam_type, classes)}>
//                             {formatDate(item.audio1_time)}
//                           </TableCell>
//                           <TableCell className={getCellClass(item, "passage1_time", exam_type, classes)}>
//                             {formatDate(item.passage1_time)}
//                           </TableCell>
//                         </>
//                       )}
//                       {exam_type !== "shorthand" && (
//                         <>
//                           <TableCell className={getCellClass(item, "trial_passage_time", exam_type, classes)}>
//                             {formatDate(item.trial_passage_time)}
//                           </TableCell>
//                           <TableCell className={getCellClass(item, "typing_passage_time", exam_type, classes)}>
//                             {formatDate(item.typing_passage_time)}
//                           </TableCell>
//                         </>
//                       )}
//                       <TableCell className={getCellClass(item, "feedback_time", exam_type, classes)}>
//                         {formatDate(item.feedback_time)}
//                       </TableCell>
//                     </TableRow>
//                   ))}
