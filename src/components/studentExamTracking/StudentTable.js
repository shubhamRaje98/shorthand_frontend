...
const StudentTable = () => {
  ...
  const fetchLocalFilterOptions = async () => {
    try {
      ...
      const url = "http://checking.shorthandonlineexam.in/track-students-on-exam-center-code/all";
  ...
  const fetchData = async (preserveFilters = false) => {
    ...
    try {
      ...
      let url = "http://checking.shorthandonlineexam.in/track-students-on-exam-center-code/";
