...
const BatchManagement = () => {
    ...
    const fetchBatches = async () => {
        try {
            const response = await axios.get('http://checking.shorthandonlineexam.in/get-all-batches');
    ...
    const handleStatusUpdate = async (batchNo, status, departmentId) => {
        try {
            const response = await axios.post('http://checking.shorthandonlineexam.in/update-batch-status', {
                batchNo,
                departmentId,
