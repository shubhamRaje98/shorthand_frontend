...
const SuperAdminDashboard = () => {
    ...
    const fetchTableNames = async () => {
        try {
            const response = await axios.get('http://43.205.192.129:3000/fetch-table-names', {
    ...
    const fetchTableData = async (tableName) => {
        try {
            const response = await axios.post('http://43.205.192.129:3000/fetch-table-data', {
                tableName
            }, {
                withCredentials: true
            });
    ...
    const submitChanges = async () => {
        try {
            const response = await axios.post('http://43.205.192.129:3000/update-table-data', {
