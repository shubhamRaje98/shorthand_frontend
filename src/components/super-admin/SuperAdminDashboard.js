...
const SuperAdminDashboard = () => {
    ...
    const fetchTableNames = async () => {
        try {
            const response = await axios.get('http://3.111.171.201:3000/fetch-table-names', {
    ...
    const fetchTableData = async (tableName) => {
        try {
            const response = await axios.post('http://3.111.171.201:3000/fetch-table-data', {
                tableName
            }, {
                withCredentials: true
            });
    ...
    const submitChanges = async () => {
        try {
            const response = await axios.post('http://3.111.171.201:3000/update-table-data', {
