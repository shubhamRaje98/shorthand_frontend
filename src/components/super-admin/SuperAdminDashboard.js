...
const SuperAdminDashboard = () => {
    ...
    const fetchTableNames = async () => {
        try {
            const response = await axios.get('http://localhost:3001/fetch-table-names', {
    ...
    const fetchTableData = async (tableName) => {
        try {
            const response = await axios.post('http://localhost:3001/fetch-table-data', {
                tableName
            }, {
                withCredentials: true
            });
    ...
    const submitChanges = async () => {
        try {
            const response = await axios.post('http://localhost:3001/update-table-data', {
