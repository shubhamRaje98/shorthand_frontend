  ...
  const fetchStats = async () => {
    try {
      ...
      const [deptRes, centerRes, batchRes, controllerRes, studentRes] = await Promise.all([
        ...
        axios.get('https://checking.shorthandonlineexam.in/api/new-department/batches'),
        axios.get('https://checking.shorthandonlineexam.in/api/new-department/controllers'),
