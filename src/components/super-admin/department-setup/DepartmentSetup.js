...
//       navigate('/super-admin/add-department');
//     } else if (stats.examCenters === 0) {
//       navigate('/super-admin/add-exam-center');
//     } else if (stats.batches === 0) {
//       navigate('/super-admin/create-batch');
//     } else if (stats.controllers === 0) {
...
//           {stats.departments === 0 ? (
//             <Button variant="primary" size="lg" onClick={handleStartSetup}>
//               Start Setup Process
//             </Button>
//           ) : progress < 100 ? (
//             <Button variant="warning" size="lg" onClick={handleContinueSetup}>
//               Continue Setup ({Math.round(progress)}% Complete)
//             </Button>
//           ) : (
...
//             <Card 
//               className={`step-card h-100 ${index === 0 || stats.departments > 0 ? '' : 'text-muted'}`}
//               style={{ cursor: 'pointer' }}
//               onClick={() => navigate(step.path)}
//             >
//               <Card.Body className="text-center">
//                 <div className={`step-number ${index === 0 || stats.departments > 0 ? 'bg-primary' : 'bg-secondary'}`}>
//                   {step.number}
//                 </div>
