...
// //         axios.get('https://checking.shorthandonlineexam.in/api/new-department/students')
// //       ]);
...
// //     try {
// //       const response = await axios.post('https://checking.shorthandonlineexam.in/api/new-department/students', formData);
      
// //       setMessage('Student registered successfully!');
      
// //       // Refresh students list
// //       const studentsRes = await axios.get('https://checking.shorthandonlineexam.in/api/new-department/students');
// //       setStudents(studentsRes.data.data || []);
