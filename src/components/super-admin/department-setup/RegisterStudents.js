...
// //     try {
// //       const response = await axios.get(`https://www.shorthandonlineexam.in/api/new-department/batches/${departmentId}`);
...
// //     try {
// //       const response = await axios.post('https://www.shorthandonlineexam.in/api/new-department/students', formData);
      
// //       setMessage('Student registered successfully!');
      
// //       // Refresh students list
// //       const studentsRes = await axios.get('https://www.shorthandonlineexam.in/api/new-department/students');
// //       setStudents(studentsRes.data.data || []);
