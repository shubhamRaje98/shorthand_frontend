...
//         ? `https://www.shorthandonlineexam.in/api/new-department/batches/${departmentId}`
//         : 'https://www.shorthandonlineexam.in/api/new-department/batches';
...
//     try {
//       let url = 'https://www.shorthandonlineexam.in/api/new-department/controllers';

//       if (departmentId && batchNo) {
//         url = `https://www.shorthandonlineexam.in/api/new-department/controllers/department/${departmentId}/batch/${batchNo}`;
//       } else if (departmentId) {
//         url = `https://www.shorthandonlineexam.in/api/new-department/controllers/department/${departmentId}`;
//       }
