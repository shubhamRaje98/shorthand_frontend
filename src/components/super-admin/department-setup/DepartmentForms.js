...
const validateControllerDatabaseReferences = async (excelData) => {
  try {
    ...
    const response = await axios.post('https://www.shorthandonlineexam.in/api/new-department/validate-controller-references', {
...
const checkBatchDuplicates = async (excelData) => {
  try {
    ...
    const response = await axios.post(
      'https://www.shorthandonlineexam.in/api/new-department/check-batch-duplicates',
...
const checkControllerDuplicates = async (excelData) => {
  try {
    ...
    // Database duplicates
    const response = await axios.post(
      'https://www.shorthandonlineexam.in/api/new-department/check-controller-duplicates',
  ...
  const handleNewDepartmentSubmit = async (e) => {
    ...
    setMessage('');
    try {
      await axios.post('https://www.shorthandonlineexam.in/api/new-department/departments', formData);
...
const handleBatchFileSelect = (e) => {
  ...
  const handleBatchFileUpload = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        'https://www.shorthandonlineexam.in/api/new-department/batches/bulk-upload-complete',
        formDataObj,
  ...
  const handleExistingDeptSubmit = async (e) => {
    ...
    try {
      await axios.post(
        'https://www.shorthandonlineexam.in/api/new-department/existing-department/batches',
        existingDeptData
      );
  ...
  const fetchBatchesByDepartment = async (departmentId) => {
    ...
    try {
      const response = await axios.get(`https://www.shorthandonlineexam.in/api/new-department/controllers/batches/department/${departmentId}`);
...
// };
  ...
  const handleControllerFileUpload = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        'https://www.shorthandonlineexam.in/api/new-department/controllers/bulk-upload-complete',
        formDataObj,
        { headers: { 'Content-Type': 'multipart/form-data' } }
      );
      setControllerFileData(prev => ({
  ...
  const handleCenterControllerSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('https://www.shorthandonlineexam.in/api/new-department/controllers', {
