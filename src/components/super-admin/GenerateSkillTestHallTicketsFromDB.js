...
//         `https://checking.shorthandonlineexam.in/api/skilltest-halltickets/db/centers?departmentId=${departmentId}`
//       );
...
//     try {
//       const response = await axios.get(
//         `https://checking.shorthandonlineexam.in/api/skilltest-halltickets/db/batches?departmentId=${departmentId}`
//       );
//       if (response.data.success) {
...
//       let url = `https://checking.shorthandonlineexam.in/api/skilltest-halltickets/db/students?departmentId=${departmentId}`;
...
//         `https://checking.shorthandonlineexam.in/api/skilltest-halltickets/db/download-hall-ticket/${student.student_id}?departmentId=${departmentId}&qrType=${qrType}`,
//         { customization },
//         { 
//           responseType: 'blob',
//           headers: {
...
//       let url = `https://checking.shorthandonlineexam.in/api/skilltest-halltickets/db/download-all-hall-tickets?departmentId=${departmentId}&qrType=${qrType}`;
