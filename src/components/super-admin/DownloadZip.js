...
// //         try {
// //             setLoading(true);
// //             const res = await axios.get('https://www.shorthandonlineexam.in/download-zip/departments');
// //             setOptions(prev => ({
// //                 ...prev,
...
// //         const res = await axios.get(`https://www.shorthandonlineexam.in/download-zip/department/${filters.departmentId}/all-batches`);
...
// //             setMessage('');
// //             const res = await axios.get(`https://www.shorthandonlineexam.in/download-zip/department/${departmentId}/batches`);
...
// //             setMessage('');
// //             const res = await axios.get(`https://www.shorthandonlineexam.in/download-zip/department/${departmentId}/batch/${batchNo}/students`);
...
// //             const response = await axios.post('https://www.shorthandonlineexam.in/download-zip/files', {
...
//             const res = await axios.get('https://www.shorthandonlineexam.in/download-zip/check-storage');
