...
// //             'https://checking.shorthandonlineexam.in/api/new-department/exam-centers-new/bulk-upload', 
// //             formData, 
// //             {
// //                 headers: {
...
// //     try {
// //       const response = await axios.get('https://checking.shorthandonlineexam.in/api/new-department/exam-centers-new/download-template', {
// //         responseType: 'blob'
// //       });
...
const AddNewExamCenter = () => {
  ...
  const fetchExamCenters = async () => {
    ...
    try {
      ...
      const response = await axios.get('https://checking.shorthandonlineexam.in/api/new-department/exam-centers');
