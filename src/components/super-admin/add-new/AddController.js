...
// // //     try {
// // //       const response = await axios.post('http://checking.shorthandonlineexam.in/api/new-department/generate-controllers');
...
// // //     try {
// // //       const response = await axios.post('http://checking.shorthandonlineexam.in/api/new-department/generate-save-controllers');
