...
const ExpertReview = () => {
  ...
  const department = departments.find(dept => 
    dept.departmentId.toString() === departmentId.toString()
  );
  ...
  return (
    <div className="er-expert-review-content">
      ...
      <div className="er-review-logs">
        ...
        <h2>{activeTab === 'expert' ? 'Expert' : 'Mod'} Review Logs for {selectedDepartment ? `${selectedDepartment} - ${getDepartmentName(selectedDepartment)}` : 'Selected Department'}</h2>
        <div className="er-search-bar">
          <input
            type="text"
            placeholder="Search logs..."
