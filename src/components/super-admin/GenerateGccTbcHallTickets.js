...
function GenerateGccTbcHallTickets() {
  ...
  const uploadExcelFile = async () => {
    ...
    try {
      ...
      const response = await axios.post('https://checking.shorthandonlineexam.in/upload-student-data', formData, {
        headers: {
  ...
  const downloadSingleHallTicket = async (student) => {
    try {
      ...
      const url = `https://checking.shorthandonlineexam.in/download-student-hall-ticket/${student.seatNo}`;
  ...
  const downloadAllHallTickets = async () => {
    try {
      ...
      window.open('https://checking.shorthandonlineexam.in/download-all-hall-tickets', '_blank');
