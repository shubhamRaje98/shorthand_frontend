...
//               {/* UPDATED: Add New Dropdown (Replaces Add Department) */}
//               <li className="sa-navbar__item sa-navbar__item--dropdown">
//                 <button
//                   className="sa-navbar__dropdown-toggle"
...
//                   <span className="sa-navbar__dropdown-arrow"></span>
//                 </button>
//                 <ul className={`sa-navbar__dropdown ${activeDropdown === 'addNew' ? 'sa-navbar__dropdown--active' : ''}`}>
//                   <li>
...
//                   </li>
//                   <li>
//                     <Link to="/super-admin/add-new-exam-center" onClick={closeDropdowns}>
//                       Add Exam Center
//                     </Link>
//                   </li>
//                 </ul>
        ...
        <ul className={`sa-navbar__nav ${isMenuOpen ? 'sa-navbar__nav--active' : ''}`}>
          {adminType === 'trackAdmin' ? (
            ...
            <>
              ...
              {/* UPDATED: Add New Dropdown with Add Controller */}
              <li className="sa-navbar__item sa-navbar__item--dropdown">
                <button
                  className="sa-navbar__dropdown-toggle"
                  onClick={() => toggleDropdown('addNew')}
