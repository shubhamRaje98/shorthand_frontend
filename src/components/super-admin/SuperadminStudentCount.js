...
const SuperAdminCount = () => {
  ...
  const fetchData = async () => {
    ...
    setError("");
    try {
      let url = "https://checking.shorthandonlineexam.in/super-admin-student-track-dashboard";
  ...
  const fetchAllData = async () => {
    ...
    setError("");
    try {
      let url = `https://checking.shorthandonlineexam.in/get-super-admin-student-count`;
