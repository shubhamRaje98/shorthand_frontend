...
//   // ✅ UPDATED: Validate Excel fields and data types
...
//       'reporting_time': 'time/string',
//       'gate_closure_time': 'time/string',
//       'batchNo': 'number',
...
//       return { valid: false, errors: ['Excel file is empty. No data found.'] };
//     }

//     // Check for missing required fields
//     const firstRow = excelData[0];
//     const excelFields = Object.keys(firstRow);
    
//     Object.keys(requiredFields).forEach(field => {
//       if (!excelFields.includes(field)) {
...
//         valid: false, 
//         errors: [
//           'Excel file is missing required fields:',
//           ...missingFields
//         ]
//       };
//     }
...
//       // Check APPLICATION_NUMBER
//       if (!row['APPLICATION_NUMBER']) {
//         errors.push(`Row ${rowNumber}: Missing APPLICATION_NUMBER`);
//       }

//       // Check fullname
//       if (!row['fullname'] || typeof row['fullname'] !== 'string') {
//         errors.push(`Row ${rowNumber}: Missing or invalid fullname (must be text)`);
//       }

//       // Check student_id
//       if (!row['student_id']) {
//         errors.push(`Row ${rowNumber}: Missing student_id`);
//       }

//       // Check center_name
//       if (!row['center_name'] || typeof row['center_name'] !== 'string') {
//         errors.push(`Row ${rowNumber}: Missing or invalid center_name (must be text)`);
//       }

//       // Check batchNo (should be number)
//       if (row['batchNo'] && isNaN(Number(row['batchNo']))) {
//         errors.push(`Row ${rowNumber}: Invalid batchNo (must be a number)`);
//       }

//       // Check photo filename
//       if (!row['photo'] || typeof row['photo'] !== 'string') {
//         errors.push(`Row ${rowNumber}: Missing or invalid photo filename`);
//       }

//       // Check sign filename
//       if (!row['sign'] || typeof row['sign'] !== 'string') {
//         errors.push(`Row ${rowNumber}: Missing or invalid signature filename`);
//       }
//     });
...
//         valid: false,
//         errors: [
//           `Found ${errors.length} validation error(s) in Excel data:`,
...
//       // ✅ Upload to backend (but don't show success yet - wait for validation)
...
//       // ✅ DON'T set success here - validation will happen in readExcelFile
...
//     try {
//       // ✅ Don't set loading here - already set in uploadExcelFile
//       setError(null);
...
//           // ✅ VALIDATE Excel data BEFORE showing success
//           const validation = validateExcelData(excelData);
          
//           if (!validation.valid) {
//             // ✅ Validation FAILED - show error, NO success message
//             setError(
//               <div>
//                 <strong>❌ Excel Validation Failed:</strong>
...
//             setLoading(false);
//             setUploadStatus('failed');
//             setSuccess(null); // ✅ Make sure no success message shows
//             return; // ✅ Stop processing
//           }

//           // ✅ Validation PASSED - now map data and show success
...
//           setSuccess(`✅ Skill Test Excel file validated and processed successfully! ${mappedStudents.length} students loaded.`);
...
//   // ✅ UPDATED: Upload tab with field display (like GCC TBC)
...
//             </p>
//             {/* ✅ ADDED: Field display like GCC TBC */}
//             <Row className="mb-4">
//               <Col md={6}>
//                 <ListGroup variant="flush" className="small">
//                   <ListGroup.Item><strong>APPLICATION_NUMBER</strong>: Application number (text/number)</ListGroup.Item>
//                   <ListGroup.Item><strong>fullname</strong>: Student's full name (text)</ListGroup.Item>
//                   <ListGroup.Item><strong>newname</strong>: Changed name (text)</ListGroup.Item>
//                   <ListGroup.Item><strong>student_id</strong>: Seat number (text/number)</ListGroup.Item>
//                   <ListGroup.Item><strong>photo</strong>: Photo filename (text)</ListGroup.Item>
//                   <ListGroup.Item><strong>sign</strong>: Signature filename (text)</ListGroup.Item>
...
//                   <ListGroup.Item><strong>disability</strong>: Disability status (text)</ListGroup.Item>
//                   <ListGroup.Item><strong>disability_type</strong>: Disability type (text)</ListGroup.Item>
//                   <ListGroup.Item><strong>batchdate</strong>: Exam date (date/text)</ListGroup.Item>
//                   <ListGroup.Item><strong>reporting_time</strong>: Reporting time (time/text)</ListGroup.Item>
//                   <ListGroup.Item><strong>gate_closure_time</strong>: Gate closure time (time/text)</ListGroup.Item>
//                   <ListGroup.Item><strong>batchNo</strong>: Batch number (number)</ListGroup.Item>
//                   <ListGroup.Item><strong>start_time</strong>: Exam start time (time/text)</ListGroup.Item>
//                 </ListGroup>
//               </Col>
//             </Row>
