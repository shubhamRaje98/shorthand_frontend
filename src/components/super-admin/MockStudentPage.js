...
const MockStudentPage = () => {
  ...
  const handleGenerate = async (mode) => {
    ...
    try {
      const res = await fetch(`http://checking.shorthandonlineexam.in/api/${mode}`, {
        method: 'POST',
  ...
  const handleAddMissing = async () => {
    ...
    try {
      ...
      const resPreview = await fetch(`http://checking.shorthandonlineexam.in/api/preview`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          batchdate: examDate,
      ...
      const resAppend = await fetch(`http://checking.shorthandonlineexam.in/api/append`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
