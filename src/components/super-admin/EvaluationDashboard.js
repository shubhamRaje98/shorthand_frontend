...
//         try {
//             const response = await axios.post('https://www.shorthandonlineexam.in/api/v1/evaluation/evaluate', {
...
//         if (excelFile) {
//             window.open(`https://www.shorthandonlineexam.in/api/v1/evaluation/download/${excelFile}`, '_blank');
//         }
//     };
    ...
    const handleStartEvaluation = async () => {
        ...
        try {
            ...
            const response = await axios.post(
                'https://www.shorthandonlineexam.in/api/v1/evaluation/evaluate',
                {
                    departmentIds: departmentIds
                },
                {
