...
const SuperAdminTrackDashboard = () => {
    ...
    const fetchFilterOptions = async () => {
        try {
            ...
            const response = await axios.post(
                'http://checking.shorthandonlineexam.in/super-admin-student-track-dashboard',
    ...
    const fetchTotalLoginCount = async (filters = currentFilters) => {
        try {
            ...
            const response = await axios.post('http://checking.shorthandonlineexam.in/total-login-count', requestBody, { withCredentials: true });
    ...
    const fetchStageCounts = async (filters = currentFilters) => {
        try {
            ...
            const response = await axios.post(
                "http://checking.shorthandonlineexam.in/super-admin-get-stage-counts",
                requestBody,
                { withCredentials: true }
            );
