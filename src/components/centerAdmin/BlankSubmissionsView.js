...
const BlankSubmissionsView = () => {
    ...
    const fetchCenterInfo = async () => {
        try {
            const response = await axios.get('http://checking.shorthandonlineexam.in/get-center-details', { withCredentials: true });
    ...
    const fetchBlankSubmissions = async () => {
        ...
        try {
            ...
            const response = await axios.get(
                `http://checking.shorthandonlineexam.in/api/blank-submissions/center/${centerInfo.center}/${batch}`,
    ...
    const handleAddComment = async (id) => {
        ...
        try {
            const response = await axios.post(
                `http://checking.shorthandonlineexam.in/api/blank-submissions/comment/${id}`,
                {
                    comment: commentText,
