...
const DepartmentStudentCount = () => {
    ...
    const fetchData = async () => {
        ...
        setError('');
        try {
            let url = 'http://checking.shorthandonlineexam.in/track-students-on-department-code';
    ...
    const fetchAllData = async () => {
        ...
        setError('');
        try {
            let url = `http://checking.shorthandonlineexam.in/get-department-batch-student-count`
            if (batchNo || center) {
                url += '?';
