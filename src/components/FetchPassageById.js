...
const FetchPassageById = () => {
    ...
    useEffect(() => {
      const fetchPassages = async () => {
        try {
            const response = await axios.get(`https://www.shorthandonlineexam.in/student-passages/${subjectId}/${qset}/${studentId}/${departmentId}`, { withCredentials: true });
    ...
    useEffect(() => {
      const fetchAudio = async () => {
        try {
            const response = await axios.get(`https://www.shorthandonlineexam.in/get-student-audio-id/${subjectId}/${qset}/${studentId}/${departmentId}`, { withCredentials: true });
