...
const CurrentStudentDetails = () => {
    ...
    const fetchDepartments = async () => {
        try {
            const response = await axios.get('http://45.119.47.81:3000/departments', { withCredentials: true });
    ...
    const fetchData = async () => {
        ...
        setError('');
        try {
            let url = 'http://45.119.47.81:3000/center-batches';
            if (departmentId) {
    ...
    const fetchAllData = async () => {
        ...
        setError('');
        try {
            let url = `http://45.119.47.81:3000/get-current-student-details`;
