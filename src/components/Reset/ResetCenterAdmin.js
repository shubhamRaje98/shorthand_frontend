...
const ResetCenterAdmin = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post('http://checking.shorthandonlineexam.in/centerrequest', formData);
  ...
  const fetchRequests = async () => {
    try {
      const response = await axios.get('http://checking.shorthandonlineexam.in/center-request-data');
