...
const ResetCenterAdmin = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post('https://checking.shorthandonlineexam.in/centerrequest', formData);
  ...
  const fetchRequests = async () => {
    try {
      const response = await axios.get('https://checking.shorthandonlineexam.in/center-request-data');
