...
const ResetRequestsAdmin = () => {
  ...
  const fetchRequests = async () => {
    try {
      const response = await axios.get('https://checking.shorthandonlineexam.in/admin/center-request-datas');
  ...
  const handleApproveReject = async (requestId, action) => {
    try {
      await axios.post('https://checking.shorthandonlineexam.in/admin/approve-reset-request', {
        requestId,
        action
      });
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://checking.shorthandonlineexam.in/centerrequest/${id}`);
